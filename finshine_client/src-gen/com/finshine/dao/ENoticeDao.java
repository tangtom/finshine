...
/** 
 * DAO for table ENOTICE.
*/
public class ENoticeDao extends AbstractDao<ENotice, Long> {

    public static final String TABLENAME = "ENOTICE";

    /**
     * Properties of entity ENotice.<br/>
     * Can be used for QueryBuilder and for referencing column names.
    */
    public static class Properties {
        public final static Property Id = new Property(0, Long.class, "id", true, "_id");
        public final static Property NoticeId = new Property(1, Long.class, "noticeId", false, "advertisementId");
    ...
    public ENoticeDao(DaoConfig config) {
        super(config);
    }
    
    public ENoticeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ENOTICE' (" + //
                "'_id' INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: id
                "'advertisementId' INTEGER," + // 1: noticeId
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ENOTICE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ENotice entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ENotice readEntity(Cursor cursor, int offset) {
        ENotice entity = new ENotice( //
            cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0), // id
            cursor.isNull(offset + 1) ? null : cursor.getLong(offset + 1), // noticeId
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ENotice entity, int offset) {
        entity.setId(cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0));
        entity.setNoticeId(cursor.isNull(offset + 1) ? null : cursor.getLong(offset + 1));
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ENotice entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ENotice entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
