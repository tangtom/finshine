...
public class DragSortListView extends ListView {
    ...
    /**
     * Transparency(透明度) for the floating View (XML attribute).
     */
...
//					Log.d(NoticeFragment.NOTICE_TAG, "onAnimationEnd:" + position);
					itemRemoveCallBack.itemRemoveCallBack(position);
				} else {
//	                Log.d(NoticeFragment.NOTICE_TAG, "itemRemoveCallBack == null");
				}
			}
		});
	...
	public void setItemRemoveCallBack(ItemRemoveCallBack removeCallBack){
		this.itemRemoveCallBack = removeCallBack;
	}
