 ...
 * @author LiNing
 */
public class FragmentSignSecondStepTwo extends FragmentDetail implements OnClickListener{
	
	View view;
	private RadioGroup radioGroupAnswer;
	private TextView radioGroupQuestion;
	public static FragmentSignSecondStepTwo newInstance(int id) {

		FragmentSignSecondStepTwo f = new FragmentSignSecondStepTwo();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_2_2, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
//		radioGroupQuestion = (TextView) view.findViewById(R.id.radioGroupQuestion);
		radioGroupAnswer = (RadioGroup) view.findViewById(R.id.radioGroupAnswer);
