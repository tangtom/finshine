 ...
 * @author LiNing
 */
public class FragmentSignSecondStepThree extends FragmentDetail implements OnClickListener{
	
	View view;
	private TextView txtRiskNum;
	private TextView txtRiskType;
	public static FragmentSignSecondStepThree newInstance(int id) {

		FragmentSignSecondStepThree f = new FragmentSignSecondStepThree();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_2_3, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
		txtRiskNum = (TextView) view.findViewById(R.id.txtRiskNum1);
		txtRiskType = (TextView) view.findViewById(R.id.txtRiskType);
