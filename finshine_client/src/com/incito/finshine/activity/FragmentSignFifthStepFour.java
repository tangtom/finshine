 ...
 * @author LiNing
 */
public class FragmentSignFifthStepFour extends FragmentDetail implements OnClickListener{
	
	View view;
	private TextView txtForthContentOne;
	public static FragmentSignFifthStepFour newInstance(int id) {

		FragmentSignFifthStepFour f = new FragmentSignFifthStepFour();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_5_4, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
		...
		txtForthContentOne = (TextView) view.findViewById(R.id.txtForthContentOne);
