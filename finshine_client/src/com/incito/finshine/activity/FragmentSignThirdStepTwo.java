 ...
 * @author LiNing
 */
public class FragmentSignThirdStepTwo extends FragmentDetail implements OnClickListener{
	
	View view;
	private EditText editBankName;
	private EditText editBankID;
	private EditText editBankCardID;
	private EditText editBankNameTotal;
	private Spinner editBillSendWay;
	private EditText editBankFax;
	private EditText editBillSendAddress;
	private EditText editFax;
	public static FragmentSignThirdStepTwo newInstance(int id) {

		FragmentSignThirdStepTwo f = new FragmentSignThirdStepTwo();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_3_2, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
		...
		editBankID = (EditText) view.findViewById(R.id.editBankID);
//		editBankCardID =(EditText) view.findViewById(R.id.editBankCardID);
//		editBankNameTotal = (EditText) view.findViewById(R.id.editBankNameTotal);
		editBillSendWay = (Spinner) view.findViewById(R.id.editBillSendWay);
//		editBankFax = (EditText) view.findViewById(R.id.editBankFax);
		editBillSendAddress = (EditText) view.findViewById(R.id.editBillSendAddress);
