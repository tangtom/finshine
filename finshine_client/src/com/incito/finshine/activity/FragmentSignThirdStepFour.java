 ...
 * @author LiNing
 */
public class FragmentSignThirdStepFour extends FragmentDetail implements OnClickListener{
	
	View view;
	private Button btnPlanTableSign;
	private Button txtPlanTableSignDate;
	
	public static FragmentSignThirdStepFour newInstance(int id) {

		FragmentSignThirdStepFour f = new FragmentSignThirdStepFour();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_3_4, container, false);
		initUI();
		return view;
	}
...
//		txtPlanTableSignDate = (Button) view.findViewById(R.id.txtPlanTableSignDate);
