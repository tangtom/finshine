 ...
 * @author LiNing
 */
public class FragmentSignFifthStepThree extends FragmentDetail implements OnClickListener{
	
	View view;
	private TextView txtThirdContentOne;
	public static FragmentSignFifthStepThree newInstance(int id) {

		FragmentSignFifthStepThree f = new FragmentSignFifthStepThree();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_5_3, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
		txtThirdContentOne = (TextView) view.findViewById(R.id.txtThirdContentOne);
