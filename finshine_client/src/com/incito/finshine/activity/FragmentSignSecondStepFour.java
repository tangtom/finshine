 ...
 * @author LiNing
 */
public class FragmentSignSecondStepFour extends FragmentDetail implements OnClickListener{
	
	View view;
	private RadioGroup radioGroupRiskSelection;
	private Button btnRiskTableSign;
	...
	public static FragmentSignSecondStepFour newInstance(int id) {

		FragmentSignSecondStepFour f = new FragmentSignSecondStepFour();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_2_4, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
//		btnRiskTableSign = (Button) view.findViewById(R.id.btnRiskTableSign);
		radioGroupRiskSelection = (RadioGroup) view.findViewById(R.id.radioGroupRiskSelection);
		txtRiskTableSignDate = (TextView) view.findViewById(R.id.txtRiskTableSignDate);
		txtCompanyAddress = (TextView) view.findViewById(R.id.txtCompanyAddress);
		txtCompanyTel = (TextView) view.findViewById(R.id.txtCompanyTel);
		txtCompanyFax = (TextView) view.findViewById(R.id.txtCompanyFax);
	}
