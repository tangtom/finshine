 ...
 * @author LiNing
 */
public class FragmentSignFifthStepTwo extends FragmentDetail implements OnClickListener{
	
	View view;
	private TextView txtSecondContentOne;
	public static FragmentSignFifthStepTwo newInstance(int id) {

		FragmentSignFifthStepTwo f = new FragmentSignFifthStepTwo();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_5_2, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
		txtSecondContentOne = (TextView) view.findViewById(R.id.txtSecondContentOne);
