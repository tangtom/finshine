 ...
 * @author LiNing
 */
public class FragmentSignThirdStepThree extends FragmentDetail implements OnClickListener{
	
	View view;
	private TextView productName;
	private TextView txtAmount;
	private TextView txtCapitalAmount;
	public static FragmentSignThirdStepThree newInstance(int id) {

		FragmentSignThirdStepThree f = new FragmentSignThirdStepThree();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.act_sign_contract_3_3, container, false);
		initUI();
		return view;
	}
	...
	private void initUI(){
		...
		txtCapitalAmount = (TextView) view.findViewById(R.id.txtCapitalAmount);
	}
