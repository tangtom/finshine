...
public class MuPDFCore
{
	...
	public synchronized Bitmap drawPage(int page,
		...
		Log.i("PDFCore","drawPage ="+ page );
		Log.i("PDFCore","pageW="+ pageW +"pageH="+ pageH );
		Log.i("PDFCore","patchX="+ patchX +"patchY="+ patchY );
		Log.i("PDFCore","patchW="+ patchW +"patchH="+ patchH );
